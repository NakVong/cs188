...
class RegressionModel(Module):
    ...
    def forward(self, x):
        ...
        """
        "*** YOUR CODE HERE ***"
        hidden_result = relu(self.hidden_layer(x))
        predicted = self.output_layer(hidden_result)
        return predicted
    ...
    def train(self, dataset):
        ...
        while True:
            for data in dataloader:
                ...
                loss.backward()
                optimizer.step()
            if self.get_loss(dataset[:]['x'], dataset[:]['label']) < 0.02:
                break
...
class DigitClassificationModel(Module):
    ...
    def __init__(self):
        ...
        output_size = 10
        "*** YOUR CODE HERE ***"
        self.hidden_layer_1 = Linear(input_size, 300)
        self.hidden_layer_2 = Linear(300, 100)
    ...
    def run(self, x):
        ...
        """
        """ YOUR CODE HERE """
        hidden_result_1 = relu(self.hidden_layer_1(x))
        hidden_result_2 = relu(self.hidden_layer_2(hidden_result_1))
        predicted = self.output_layer(hidden_result_2)
        return predicted
...
class LanguageIDModel(Module):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        # Initialize your model parameters here
        self.hidden_layer = Linear(self.num_chars, 128)
    ...
    def run(self, xs):
        ...
        temp = tensor([0.0] * 128)
        for letter in xs:
            temp = relu(self.hidden_layer(letter) + temp)
        result = self.output_layer(temp)
        return result
